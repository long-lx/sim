<?php /* Smarty version Smarty-3.0.7, created on 2013-05-29 09:03:20
         compiled from "./templates/thanhvienadd.htm" */ ?>
<?php /*%%SmartyHeaderCode:66288044751a561e803cc00-37798946%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '57a1182194f7514a39ee16687e0609aaaeaf4d6a' => 
    array (
      0 => './templates/thanhvienadd.htm',
      1 => 1369792997,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '66288044751a561e803cc00-37798946',
  'function' => 
  array (
  ),
...
" /></strong></p>
				...
				<tr class="ui-widget-content">
					<td style="width: 50%; height: 22px; text-align: left;">
					<p style="margin-left: 15px; margin-top: 0; margin-bottom: 0">
					<strong style="color:#FF0000; font-weight:bold;">% Hoa hồng:</strong></p>
					</td>
					<td style="width: 50%; height: 22px; text-align: left;">
					<p style="margin-left: 15px; margin-top: 0; margin-bottom: 0">
					<strong>
					<input name="post[pt]" type="text" style="width: 107px" value="<?php echo $_smarty_tpl->getVariable('pt')->value;?>
" /></strong></p>
					</td>
				</tr>
				<tr class="ui-widget-content">
					...
					<p style="margin-left: 15px; margin-top: 0; margin-bottom: 0">
					<strong>
					<input name="post[username]" type="text" style="width: 107px" value="<?php echo $_smarty_tpl->getVariable('hovaten')->value;?>
" /></strong></p>
					</td>
				</tr>
				<tr>
