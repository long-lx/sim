...
Mobile: ".$r['mobile']."
Gi chu: ".$r2['text']);
		@mail("my.sevice@gmail.com","Dat sim ".$r2['sosim']." gia ".number_format($r2['giatien'],0,",",",")."",$mailtxt2,$headers);
		}
		else 
		{
		$q4=query("SELECT * FROM dondathang WHERE cidmd5='".$r['cidmd5']."'");
		$r4=fecth($q4);
		if ($r4['domain']=="sodep123.com")$lh="0989.66.0000";
		elseif ($r4['domain']=="nganhangsimsodep.com")$lh="0936.666.886";
		elseif ($r4['domain']=="simsodep.hn")$lh="0914.77.9999";
		elseif ($r4['domain']=="sodep.hn")$lh="0986.77.8668";
		else 
		$lh="0937.666.886";
		echo "Quy khach xac nhan don dat hang khong thanh cong! vui long lien he: ".$lh." de xac nhan!";	
		}
	}
else 
{
	echo "xac nhan khong thang cong! So dien thoai lien he khong khop voi so dien thoai quy khach nhan tin xac nhan!";
}
}
?>