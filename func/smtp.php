...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname="Sindre Design")
{
      ...
      $smtp_host ='mail.cp.stv.vn';//Dia chi mail server
      $admin_email = 'admin@cp.stv.vn';//User duoc khai bao tren mail server
      $smtp_username = 'admin@cp.stv.vn';//User duoc khai bao tren mail server
      $smtp_password = '@anhyeuem123';//Pass cua email nay
